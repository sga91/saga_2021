...
The aim of this analysis is to define promoter types in Drosophila ovaries cells based on the presence of specific core promoter elements
...
options(knitr.figure_dir = "plots/figure_s1")
...
## Define the function to find promoter element (motifs) in each active tss
...
save(motif_df_1mm, file="./rdata/motif_df_ovaries_1mm.RData")
save(motif_df_0mm, file="./rdata/motif_df_ovaries_0mm.RData")
...
hk_tss <- tss[tss$fb_t_id %in% subset(motif_df_0mm, !(TATA | TCT | MTE | DPE | DPE_K | DPE_O | PB | Inr) & 
                                                     (DRE | Motif1 | Motif6 | Motif7))$fb_t_id]

motif_list_ovaries <- list(tata=tata_tss, dpe=dpe_tss, tct=tct_tss, hk=hk_tss)
save(motif_list_ovaries, file="./rdata/motif_list_ovaries.RData")
